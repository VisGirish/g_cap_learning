using { mycapapp.db.master, mycapapp.db.transaction } from '../db/datamodel';
...
service CatalogService @(path: 'CatalogService') {
    ...
    entity POs @(odata.draft.enabled : true,Common.DefaultValuesFunction: 'loadInitials') as projection on transaction.purchaseorder{
        *,
        case OVERALL_STATUS
            when 'N' THEN 'New'
